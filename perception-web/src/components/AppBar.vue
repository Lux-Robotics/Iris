<template>
  <v-app-bar density="compact">
    <template #prepend>
      ...
      <span class="mx-2 font-weight-black">Peninsula Perception</span>
      <span class="text-grey-lighten-1">v2024.4.3</span>
    </template>
  ...
  <v-navigation-drawer v-model="drawer">
    <v-list>
      <v-list-item link prepend-icon="mdi-view-dashboard" title="Dashboard" to="/" />
