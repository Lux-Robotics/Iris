...
onMounted(() => {
	const brightnessTopic: NetworkTablesTopic<number> = ntcore.createTopic(
		"brightness",
		NetworkTablesTypeInfos.kInteger,
	);
	const exposureTopic: NetworkTablesTopic<number> = ntcore.createTopic(
		"exposure",
		NetworkTablesTypeInfos.kInteger,
	);
	const gainTopic: NetworkTablesTopic<number> = ntcore.createTopic(
		"gain",
		NetworkTablesTypeInfos.kInteger,
	);
